...
var fadeSlideShow_descpanel={
	controls: [['resources/x.png',7,7], ['resources/restore.png',10,11], ['resources/loading.gif',16,16]], //full URL and dimensions of close, restore, and loading images
	fontStyle: 'normal 18px Verdana', //font style for text descriptions
...
fadeSlideShow.routines={
	...
	adddescpanel:function($, setting){
		...
		$('<div class="descpanelbg"></div><div class="descpanelfg"></div>') //create inner nav panel DIVs
			...
			.eq(0).css({background:'white', opacity:0.6}).end() //"descpanelbg" div
