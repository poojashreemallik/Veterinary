...
<div id="fadeshow"></div>
	...
	<table>
		...
		<c:forEach items="${list}" var="std">
				...
				<td><c:out value="${std.clientid}"/></td><td>&nbsp;</td>
				<td><c:out value="${std.farmerName}"/></td><td>&nbsp;</td>
				<td>&nbsp;</td>
				<td><a href="clientcase.html?id=${std.clientid}">Click here to add case</a></td>
		</c:forEach>
		</tr>
	</table>
	
	
	<a href="createClient.html">New Client</a>
<!-- 
