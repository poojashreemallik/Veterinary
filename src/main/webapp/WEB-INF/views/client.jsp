...
<h3> REGISTRATION FORM</h3>
		...
		<form:form action="createClient.html" method="post" >
		<table >
		...
		<!----- Farmer Name ---------------------------------------------------------->
		<tr>
			<td align="right"><form:label path="farmerName">FATHER NAME:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form:label></td>
			<td align="left"><form:input path="farmerName" required="required"/></td>
		...
		<tr>
			<td align="right"><form:label path="adhaarnumber">ADHAR NUMBER:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form:label></td>
			<td align="left"><form:input path="adhaarnumber" required="required"/></td>
		</tr>
