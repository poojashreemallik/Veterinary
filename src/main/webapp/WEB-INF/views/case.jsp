...
<h3> CASE REGISTER HERE</h3>
		
		<form:form action="createCase.html" method="post" >
		<table >
		...
		<!----- Farmer Name ---------------------------------------------------------->
		<tr>
			<td align="right"><form:label path="client.clientid">CLIENT ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form:label></td>
			<td align="left"><form:input path="client.clientid"  required="required"/></td>
		...
		<!----- Description ---------------------------------------------------------->
		<tr>
			<td align="right" valign="top"><form:label path="case1.description">DESCRIPTION:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form:label></td>
			<td align="left"><form:textarea path="case1.description" rows="5" cols="30" required="required"/></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		</tr>
		<!----- Symptoms ---------------------------------------------------------->
		<tr>
			<td align="right" valign="top"><form:label path="case1.symptoms">SYMPTOMS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form:label></td>
			<td align="left"><form:textarea path="case1.symptoms" rows="5" cols="30" required="required"/></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		</tr>
